...
temp_dir = r"C:\Users\Labre\Downloads"
            ...
            if a_tag:
                ...
                if parsed_date:
                    ...
                    if parsed_date.date() == now:
                        ...
                        text_subtitle = li.find('span', class_='text subtitle').text.strip()
...
mail_user = 'pythondev@labrecquev.ca'
sent_from = mail_user
sent_to = 'labrecquev@gmail.com'

subject = f'Rattrapage Radio-Canada du {now}'
